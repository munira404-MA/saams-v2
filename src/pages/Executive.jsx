  ...
  return (
    <section className="executive-page">
      <div className="module-heading">
        <div><span className="eyebrow">SAAMS v3.0</span><h1>{ar?'لوحة المدير العام':'Executive Dashboard'}</h1><p>{ar?'ملخص تنفيذي موحد للفواتير والسلف والأصول والحضانات.':'Unified executive overview of invoices, advances, assets, and nurseries.'}</p></div>
